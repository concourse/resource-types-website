...
type FakeWrapperInterface struct {
...
func (fake *FakeWrapperInterface) GetStars(arg1 map[string]int) (map[string]int, error) {
...
func (fake *FakeWrapperInterface) GetStarsCallCount() int {
	fake.getStarsMutex.RLock()
	defer fake.getStarsMutex.RUnlock()
	return len(fake.getStarsArgsForCall)
}

func (fake *FakeWrapperInterface) GetStarsCalls(stub func(map[string]int) (map[string]int, error)) {
	fake.getStarsMutex.Lock()
	defer fake.getStarsMutex.Unlock()
	fake.GetStarsStub = stub
}

func (fake *FakeWrapperInterface) GetStarsArgsForCall(i int) map[string]int {
	fake.getStarsMutex.RLock()
	defer fake.getStarsMutex.RUnlock()
...
func (fake *FakeWrapperInterface) GetStarsReturns(result1 map[string]int, result2 error) {
	fake.getStarsMutex.Lock()
	defer fake.getStarsMutex.Unlock()
...
func (fake *FakeWrapperInterface) GetStarsReturnsOnCall(i int, result1 map[string]int, result2 error) {
	fake.getStarsMutex.Lock()
	defer fake.getStarsMutex.Unlock()
	fake.GetStarsStub = nil
...
func (fake *FakeWrapperInterface) Invocations() map[string][][]interface{} {
...
func (fake *FakeWrapperInterface) recordInvocation(key string, args []interface{}) {
...
var _ githubwrapper.WrapperInterface = new(FakeWrapperInterface)
